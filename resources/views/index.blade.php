      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="dist/img/view.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs">Suphisi Khaika</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="dist/img/view.jpg" class="img-circle" alt="User Image">
                <p>
                  Suphisit Khaika - Web Developer
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li>
          <a href=" ">
            <i class="fa  fa-columns"></i> <span>Template</span>
